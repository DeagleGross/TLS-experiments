...
namespace FdBlockingWorkers.Interop;

/// <summary>
/// OpenSSL P/Invoke surface — identical to experiment 04c so the only thing
/// that differs between 04c and 04d is the dispatch model in Program.cs.
/// </summary>
